...
void Engine::ProcessInput()
{
	...
	if (!bProcessedByScene)
	{
		...
		{
			this->m_pPlayer->m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimTracks++, pKeysBuffer[VK_SPACE] & 0xF0 ? ANIMATION_MOVE_BACKWARD : ANIMATION_IDLE);
			dwDirection |= DIR_BACKWARD;
		}
		if (pKeysBuffer[VK_LSHIFT] & 0xF0)
		{
			this->m_pPlayer->m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimTracks++, pKeysBuffer[VK_LSHIFT] & 0xF0 ? ANIMATION_MOVE_LEFT : ANIMATION_IDLE);
			dwDirection |= DIR_LEFT;

		}
		if (pKeysBuffer[VK_RSHIFT] & 0xF0)
		{
			this->m_pPlayer->m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimTracks++, pKeysBuffer[VK_RSHIFT] & 0xF0 ? ANIMATION_MOVE_RIGHT : ANIMATION_IDLE);
			dwDirection |= DIR_RIGHT;
		}
		if (pKeysBuffer[VK_LSHIFT] & pKeysBuffer[VK_RSHIFT] & 0xF0)
		{
			this->m_pPlayer->m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimTracks++, pKeysBuffer[VK_LSHIFT] & pKeysBuffer[VK_RSHIFT] & 0xF0 ? ANIMATION_MOVE_FORWARD : ANIMATION_IDLE);
		...
		{
			this->m_pPlayer->m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimTracks++, pKeysBuffer['A'] & 0xF0 ? ANIMATION_HOOK_L : ANIMATION_IDLE);
		...
		{
			this->m_pPlayer->m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimTracks++, pKeysBuffer[VK_OEM_7] & 0xF0 ? ANIMATION_HOOK_R : ANIMATION_IDLE);
		...
		{
			this->m_pPlayer->m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimTracks++, pKeysBuffer['S'] & 0xF0 ? ANIMATION_JAB : ANIMATION_IDLE);
		...
		{
			this->m_pPlayer->m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimTracks++, pKeysBuffer['C'] & 0xF0 ? ANIMATION_GUARD_LEFT_HEAD : ANIMATION_IDLE);
		...
		{
			this->m_pPlayer->m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimTracks++, pKeysBuffer[VK_OEM_COMMA] & 0xF0 ? ANIMATION_GUARD_RIGHT_HEAD : ANIMATION_IDLE);
		...
		{
			this->m_pPlayer->m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimTracks++, pKeysBuffer['6'] & 0xF0 ? ANIMATION_GUARD_BODY : ANIMATION_IDLE);
		...
		{
			this->m_pPlayer->m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimTracks++, pKeysBuffer['7'] & 0xF0 ? ANIMATION_HIT_TORSO_LEFT_A: ANIMATION_IDLE);
		...
		{
			this->m_pPlayer->m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimTracks++, pKeysBuffer['8'] & 0xF0 ? ANIMATION_HIT_TORSO_RIGHT_A : ANIMATION_IDLE);
		...
		{
			this->m_pPlayer->m_pSkinnedAnimationController->SetTrackAnimationSet(nAnimTracks++, pKeysBuffer['9'] & 0xF0 ? ANIMATION_HIT_TORSO_STRIGHT_A : ANIMATION_IDLE);
