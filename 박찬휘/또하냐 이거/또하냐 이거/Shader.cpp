...
void CAngrybotObjectsShader::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, CLoadedModelInfo *pModel, void *pContext)
{
	...
	for (int x = -xObjects; x <= xObjects; x++)
	{
		for (int z = -zObjects; z <= zObjects; z++)
		{
			...
			m_ppObjects[nObjects]->m_pSkinnedAnimationController->SetTrackAnimationSet(0, make_pair((nObjects % 2), 0));
...
void CEthanObjectsShader::BuildObjects(ID3D12Device *pd3dDevice, ID3D12GraphicsCommandList *pd3dCommandList, ID3D12RootSignature *pd3dGraphicsRootSignature, CLoadedModelInfo *pModel, void *pContext)
{
	...
	for (int x = -xObjects; x <= xObjects; x++)
	{
		for (int z = -zObjects; z <= zObjects; z++)
		{
			...
			m_ppObjects[nObjects]->m_pSkinnedAnimationController->SetTrackAnimationSet(0, make_pair((nObjects % 4), 0));
...
void UserInterfaceShader::Render(ID3D12GraphicsCommandList* pd3dCommandList, CCamera* pCamera)
{
	if (active)
	{
...
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSTextureUI_KeyRightShift", "vs_5_1", &m_pd3dVertexShaderBlob));
}

D3D12_SHADER_BYTECODE UI_KeyInput_Right_Shift::CreatePixelShader()
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSTextureUI_KeyRightShift", "ps_5_1", &m_pd3dPixelShaderBlob));
}
...
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSTextureUI_KeyLeftShift", "vs_5_1", &m_pd3dVertexShaderBlob));
}

D3D12_SHADER_BYTECODE UI_KeyInput_Left_Shift::CreatePixelShader()
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSTextureUI_KeyLeftShift", "ps_5_1", &m_pd3dPixelShaderBlob));
}
...
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSTextureUI_PlayerTotalScore", "vs_5_1", &m_pd3dVertexShaderBlob));
}

D3D12_SHADER_BYTECODE UI_PlayerTotalScore::CreatePixelShader()
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSTextureUI_PlayerTotalScore", "ps_5_1", &m_pd3dPixelShaderBlob));
}
...
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "VSTextureUI_OtherPlayerTotalScore", "vs_5_1", &m_pd3dVertexShaderBlob));
}

D3D12_SHADER_BYTECODE UI_OtherPlayerTotalScore::CreatePixelShader()
{
	return(CShader::CompileShaderFromFile(L"Shaders.hlsl", "PSTextureUI_OtherPlayerTotalScore", "ps_5_1", &m_pd3dPixelShaderBlob));
}
