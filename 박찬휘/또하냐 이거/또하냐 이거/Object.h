...
public:
	...
	bool IsAnimate();
	void Animate(CGameObject* object);
};
...
public:
	...
	pair<UINT, UINT> 				m_nAnimationSet{};

public:
	void SetAnimationSet(int nAnimationSet) { m_nAnimationSet.first = nAnimationSet; }
...
public:
	...
	void SetTrackAnimationSet(int nAnimationTrack, pair<UINT, UINT> nAnimationSet, UINT nType = ANIMATION_TYPE_ONCE, bool bAnimFixed = true);
	...
	void SetCallbackKey(int nAnimationSet, int nKeyIndex, float fTime, void *pData);
	void SetAnimationCallbackHandler(int nAnimationSet, CAnimationCallbackHandler *pCallbackHandler);
	void SetSpinePosition(CGameObject* object);
...
public:
	...
	void SetTrackAnimationSet(int nAnimationTrack, pair<UINT, UINT> nAnimationSet);
