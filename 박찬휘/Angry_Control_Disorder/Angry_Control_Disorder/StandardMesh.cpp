...
{
	RELEASE(m_pd3dTextureCoord0Buffer);
	RELEASE(m_pd3dNormalBuffer);
	RELEASE(m_pd3dTangentBuffer);
	RELEASE(m_pd3dBiTangentBuffer);
...
void StandardMesh::ReleaseUploadBuffers()
{
	...
	RELEASE(m_pd3dTextureCoord0UploadBuffer);
	RELEASE(m_pd3dNormalUploadBuffer);
	RELEASE(m_pd3dTangentUploadBuffer);
	RELEASE(m_pd3dBiTangentUploadBuffer);
