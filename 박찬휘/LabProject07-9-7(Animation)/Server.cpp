...
void Server::Server_send()
{
	...
	if (send_count == 0) {
		...
		//cout << "Player Position : " << cplayer->m_xmf4x4World._41 << ", " << cplayer->m_xmf4x4World._42 << ", " << cplayer->m_xmf4x4World._43 << endl;
		cout << "Player Position : " << player.player_world._41 << ", " << player.player_world._42 << ", " << player.player_world._43 << endl;
