...
void Camera::CaptureWorld()
{
	...
	{
		cout << "(" << m_xmf3CapturedLook.x << ", " << m_xmf3CapturedLook.y << ", " << m_xmf3CapturedLook.z << ")\n";
		cout << "(" << m_xmf3CapturedRight.x << ", " << m_xmf3CapturedRight.y << ", " << m_xmf3CapturedRight.z << ")\n";
		cout << "(" << m_xmf3CapturedUp.x << ", " << m_xmf3CapturedUp.y << ", " << m_xmf3CapturedUp.z << ")\n";
		cout << "(" << m_xmf3CapturedPosition.x << ", " << m_xmf3CapturedPosition.y << ", " << m_xmf3CapturedPosition.z << ")\n";
	}
}
