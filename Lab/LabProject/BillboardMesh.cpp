...
BillboardMesh::BillboardMesh(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, float fWidth, float fHeight, float fDepth, float fxPosition, float fyPosition, float fzPosition)
...
void BillboardMesh::OnPreRender(ID3D12GraphicsCommandList* pd3dCommandList, void* pContext)
{
}

void BillboardMesh::Render(ID3D12GraphicsCommandList* pd3dCommandList, int nSubSet)
{
