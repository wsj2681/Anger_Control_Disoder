...
void CGameFramework::UpdateShaderVariables()
{
	...
	::memcpy(&m_pcbMappedFrameworkInfo->m_xmf4x4WaterAnimation, &xmf4x4WaterAnimation, sizeof(XMFLOAT4X4));
...
void CGameFramework::UpdatesObjects()
{
	float fTimeElapsed = m_GameTimer.GetTimeElapsed();

	if (m_pScene) m_pScene->UpdatesObjects(fTimeElapsed);
