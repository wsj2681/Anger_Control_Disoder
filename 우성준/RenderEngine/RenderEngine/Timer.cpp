...
Timer::Timer()
{
	...
	basePerformaceCounter = lastPerformanceCounter;
...
{
	if (stopped) return(float(((stopPerformanceCounter - pausedPerformanceCounter) - basePerformaceCounter) * timeScale));
	return(float(((currentPerformanceCounter - pausedPerformanceCounter) - basePerformaceCounter) * timeScale));
}
...
void Timer::Reset()
{
	...
	basePerformaceCounter = nPerformanceCounter;
