...
constexpr UINT ANIMATION_JAB_KICK = 0x28;			// Jab_Kick
constexpr UINT ANIMATION_DIAGONAL_ELBOW_L = 0x29;	// Diagonal_Elbow_L
constexpr UINT ANIMATION_DIAGONAL_ELBOW_R = 0x2A;	// Diagonal_Elbow_R
constexpr UINT ANIMATION_DOWNWARD_ELBOW_R = 0x2B;	// Downward_Elbow_R
constexpr UINT ANIMATION_ELBOW_L = 0x2C;			// Elbow_L
constexpr UINT ANIMATION_ELBOW_R = 0x2D;			// Elbow_R
constexpr UINT ANIMATION_UPPER_ELBOW_L = 0x2E;		// Upper_Elbow_L
constexpr UINT ANIMATION_UPPER_ELBOW_R = 0x2F;		// Upper_Elbow_R
constexpr UINT ANIMATION_HIT_HEAD_STRIGHT_B = 0x30; // Hit_Head_Stright_B
constexpr UINT ANIMATION_AXE_KICK_R = 0x31;			// Axe_Kick_R
constexpr UINT ANIMATION_CRANE_KICK_R = 0x32;		// Crane_Kick_R
constexpr UINT ANIMATION_KICK_HIGH_L = 0x33;		// Kick_High_L
constexpr UINT ANIMATION_KICK_MID_L = 0x34;			// Kick_Mid_L
constexpr UINT ANIMATION_LOW_KICK_360_R = 0x35;		// Low_Kick_360_R
constexpr UINT ANIMATION_LOW_KICK_R = 0x36;			// Low_Kick_R
constexpr UINT ANIMATION_LOW_KICK_SL = 0x37;		// Low_Kick_Shortened (KickBoxing Style)_L
constexpr UINT ANIMATION_MAEGERI_BODY_R = 0x38;		// MaeGeri_Body(Karate Kick)_R
constexpr UINT ANIMATION_MAEGERI_HEAD_R = 0x39;		// MaeGeri_Head(Karate Kick)_R
constexpr UINT ANIMATION_MIKAZUKIGERI_R = 0x3A;		// MikazukiGeri(Karate)_R
constexpr UINT ANIMATION_PUSH_KICK_R = 0x3B;		// Push_Kick (Muat Thai)_R
constexpr UINT ANIMATION_SHORT_LOW_KICK_L = 0x3C;	// Short_Low_Kick_L
constexpr UINT ANIMATION_SIDE_KICK_L = 0x3D;		// Side_Kick_L
constexpr UINT ANIMATION_SIDE_KICK_R = 0x3E;		// Side_Kick_R
constexpr UINT ANIMATION_URAMIKAZUKIGERI_R = 0x3F;	// UraMikazukiGeri(Karate)_R
