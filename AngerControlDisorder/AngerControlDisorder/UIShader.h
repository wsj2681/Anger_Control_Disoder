...
class UI_HPBackGround_Player : public UserInterfaceShader
{
public:
	UI_HPBackGround_Player();
	UI_HPBackGround_Player(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, wchar_t* filePath);
	virtual ~UI_HPBackGround_Player();
...
class UI_HPBackGround_OtherPlayer : public UserInterfaceShader
{
public:
	UI_HPBackGround_OtherPlayer();
	UI_HPBackGround_OtherPlayer(ID3D12Device* pd3dDevice, ID3D12GraphicsCommandList* pd3dCommandList, ID3D12RootSignature* pd3dGraphicsRootSignature, wchar_t* filePath);
	virtual ~UI_HPBackGround_OtherPlayer();
